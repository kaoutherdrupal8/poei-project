...
/* themes/ive/templates/node--article--full.html.twig */
class __TwigTemplate_d5c2e7ac9886db960df680d415143dd9a7b149ed489998e91fde8b8758bfd143 extends Twig_Template
{
    ...
    {
        $tags = array("set" => 80, "if" => 94, "trans" => 104);
        $filters = array("clean_class" => 82);
        $functions = array("attach_library" => 90);
...
";
        // line 80
        $context["classes"] = array(0 => "node", 1 => ("node--type-" . \Drupal\Component\Utility\Html::getClass($this->getAttribute(        // line 82
($context["node"] ?? null), "bundle", array()))), 2 => (($this->getAttribute(        // line 83
($context["node"] ?? null), "isPromoted", array(), "method")) ? ("node--promoted") : ("")), 3 => (($this->getAttribute(        // line 84
($context["node"] ?? null), "isSticky", array(), "method")) ? ("node--sticky") : ("")), 4 => (( !$this->getAttribute(        // line 85
($context["node"] ?? null), "isPublished", array(), "method")) ? ("node--unpublished") : ("")), 5 => ((        // line 86
...
<article";
  ...
  <div";
    ...
    ";
        // line 112
        echo "    ";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->attachLibrary("ive/tabs"), "html", null, true));
        echo "
    <div id=\"tabs\">
      <ul>
        <li><a href=\"#tabs-1\">";
        // line 115
        echo t("Détails", array());
        echo "</a></li>
        <li><a href=\"#tabs-2\">";
        // line 116
        echo t("Image", array());
...
";
    ...
    {
        return "themes/ive/templates/node--article--full.html.twig";
    }
    ...
    {
        return array (  150 => 126,  144 => 123,  138 => 120,  132 => 117,  128 => 116,  124 => 115,  117 => 112,  113 => 110,  110 => 109,  104 => 106,  101 => 105,  99 => 104,  95 => 103,  91 => 102,  88 => 101,  86 => 100,  81 => 99,  73 => 96,  68 => 95,  66 => 94,  62 => 93,  57 => 91,  53 => 90,  51 => 86,  50 => 85,  49 => 84,  48 => 83,  47 => 82,  46 => 80,  43 => 78,);
    }
...
/**
 * @file
 * ive's theme implementation to display a node.
 *
 * Available variables:
...
{%
 set date = created|format_date('long')
%}
#}
...
<article{{ attributes.addClass(classes) }}>
  ...
  <div{{ content_attributes.addClass('node__content', 'clearfix') }}>
    ...
    <div id=\"tabs\">
      <ul>
        <li><a href=\"#tabs-1\">{%trans%}Détails{%endtrans%}</a></li>
        <li><a href=\"#tabs-2\">{%trans%}Image{%endtrans%}</a></li>
        <li><a href=\"#tabs-3\">{%trans %}Commentaires{%endtrans%}</a></li>
      </ul>
      <div id=\"tabs-1\">
        {{content.body}}
      </div>
...
", "themes/ive/templates/node--article--full.html.twig", "/var/www/user6.d8.lab/htdocs/themes/ive/templates/node--article--full.html.twig");
    }
}
